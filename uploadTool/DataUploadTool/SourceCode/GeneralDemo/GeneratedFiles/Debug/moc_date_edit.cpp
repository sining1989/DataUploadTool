/****************************************************************************
** Meta object code from reading C++ file 'date_edit.h'
**
...
#include "../../Include/date_edit.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'date_edit.h' doesn't include <QObject>."
...
void CDateEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        CDateEdit *_t = static_cast<CDateEdit *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject CDateEdit::staticMetaObject = {
    { &QDateEdit::staticMetaObject, qt_meta_stringdata_CDateEdit.data,
      qt_meta_data_CDateEdit,  qt_static_metacall, nullptr, nullptr}
};
